...
function RelatedItem(props) {
  ...
  return (
    <div className="col-xs-12 col-sm-12 col-md-6 col-lg-3 realated__product sidebar__product realated__product--detail">
      ...
      <div className="card text-center">
        ...
        <div className="card-body realated__product-item--body">
          ...
          <p className="card-text realated__product-item--text">
            <span className="shopdetail__top-price--sale">${item.sale}</span>
